...
def get_train_test(args):
    ...
    if args.debug and args.task == "math":
        ...
        if args.task == "math" and args.math_type == "all_types":
            ...
            tasks = []
            with open("GAIA/2023/validation/metadata.jsonl", "r", encoding="utf-8") as f:
                for line in f:
                    tasks.append(json.loads(line))
            tasks = filter_gaia_tasks(tasks)
            print("Total number of GAIA tasks: ", len(tasks))
            train_ids = []
            ...
            return train_data, test_data[:1]  # TODO: Select test tasks
